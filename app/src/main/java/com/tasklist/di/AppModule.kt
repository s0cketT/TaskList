...
import com.tasklist.domain.use_case.DeleteFavoritesUseCase
...
import com.tasklist.domain.use_case.InsertFavoritesUseCase
import com.tasklist.domain.use_case.IsPostFavoritesUseCase
...
val appModule = module {
    ...
    factory<InsertFavoritesUseCase> { InsertFavoritesUseCase(insertFavoritesRepository = get<IPostFavoritesRepository>()) }
    factory<DeleteFavoritesUseCase> { DeleteFavoritesUseCase(deleteFavoritesRepository = get<IPostFavoritesRepository>()) }
    factory<IsPostFavoritesUseCase> { IsPostFavoritesUseCase(isFavorites = get<IPostFavoritesRepository>()) }
    ...
    viewModel<PostApiViewModel> { PostApiViewModel(
        ...
        insertFavoritesUseCase = get<InsertFavoritesUseCase>(),
        deleteFavoritesUseCase = get<DeleteFavoritesUseCase>(),
        isPostFavoritesUseCase = get<IsPostFavoritesUseCase>()
        ) }
